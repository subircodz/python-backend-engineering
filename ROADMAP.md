...
- [x] dict — **COMPLETE**; covered fundamentals, creation/syntax, key access and mutation, `get()`, views and iteration, removal operations, membership, filtering/transformation, nested dictionaries, `update()`, `setdefault()`, `defaultdict`, practical backend transformations, retrieval, and the Dictionary Record Manager practical.
- [ ] comprehensions
- [ ] `collections`
...
Target titles will be selected from actual job requirements rather than arbitrary technology checklists.
